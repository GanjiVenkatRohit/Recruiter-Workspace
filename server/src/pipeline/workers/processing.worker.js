...
processingQueue.process(async (job) => {
  ...
  try {
    ...
    const fileData = await fs.promises.readFile(actualFilePath);
    ...
    // Call dedicated NLP Resume Parser
    ...
    try {
      ...
      if (existingCandidate) {
        ...
        // Link upload_status and resume_content to the existing candidate ID
