...
function subscribeToInProcessEvents() {
  try {
    ...
    const subscriber = {
      eventTypes: ['CandidateCreated', 'CandidateUpdated', 'CandidateDeleted'],
      aggregateId: null,
      res: {
        write(chunk) {
          try {
    ...
    console.log('[WebSocket] Subscribed to in-process CandidateCreated/CandidateUpdated events');
  } catch (err) {
...
module.exports = { initWebSocketServer, closeWebSocketServer, broadcast, clients };
